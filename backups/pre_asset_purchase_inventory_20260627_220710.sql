...
\restrict KbDNUeja7t2T30GJfZwitz0ZgoqLvaQv2pg1de5dRC0IsrvQfsXaHjm3CigjJ5E
...
--
-- Name: asset_change_requests; Type: TABLE; Schema: public; Owner: admin
--
...
ALTER TABLE public.asset_change_requests OWNER TO admin;

--
-- Name: asset_items; Type: TABLE; Schema: public; Owner: admin
--
...
ALTER TABLE public.asset_items OWNER TO admin;

--
-- Name: asset_settings; Type: TABLE; Schema: public; Owner: admin
--
...
ALTER TABLE public.asset_settings OWNER TO admin;

--
-- Name: asset_suppliers; Type: TABLE; Schema: public; Owner: admin
--

CREATE TABLE public.asset_suppliers (
    id text NOT NULL,
...
ALTER TABLE public.asset_suppliers OWNER TO admin;
...
--
-- Name: task_files; Type: TABLE; Schema: public; Owner: admin
--
...
CREATE TABLE public.task_files (
    ...
    size integer NOT NULL,
    mime_type text NOT NULL,
    file_type text DEFAULT 'completion'::text NOT NULL,
    uploaded_by text,
    uploaded_at timestamp(3) without time zone DEFAULT CURRENT_TIMESTAMP NOT NULL
);


ALTER TABLE public.task_files OWNER TO admin;
...
bdc68853-0113-4e39-b587-2d8acfa5307d	8cddf0f8f90e62379919dbb120b9a98083ca4ba0d1a665a94035a1516460e344	2026-06-27 13:32:59.769945+00	20260627133148_asset_management_core	\N	\N	2026-06-27 13:32:59.683511+00	1
...
017de72a-78af-4374-9c25-51b6d147016d	3aacc36fceca0a170a76e33a88e17fac4e6c8f3432b59e9b92bf33f393463698	2026-06-27 02:15:42.611075+00	20260627101500_task_completion_workflow	\N	\N	2026-06-27 02:15:42.57035+00	1
b0750e31-a728-4397-a895-73b2144ac196	5ed306c27aa920e1afb1207f806e53f5fd63659ea19476d956a3de32b50f1848	\N	20260627133148_asset_management_core	A migration failed to apply. New migrations cannot be applied before the error is recovered from. Read more about how to resolve migration issues in a production database: https://pris.ly/d/migrate-resolve\n\nMigration name: 20260627133148_asset_management_core\n\nDatabase error code: 23503\n\nDatabase error:\nERROR: insert or update on table "approval_records" violates foreign key constraint "fk_approval_procurement"\nDETAIL: Key (request_id)=(1633fc3b-01f5-4fe4-8904-877d09150a33) is not present in table "procurement_requests".\n\nDbError { severity: "ERROR", parsed_severity: Some(Error), code: SqlState(E23503), message: "insert or update on table \\"approval_records\\" violates foreign key constraint \\"fk_approval_procurement\\"", detail: Some("Key (request_id)=(1633fc3b-01f5-4fe4-8904-877d09150a33) is not present in table \\"procurement_requests\\"."), hint: None, position: None, where_: None, schema: Some("public"), table: Some("approval_records"), column: None, datatype: None, constraint: Some("fk_approval_procurement"), file: Some("ri_triggers.c"), line: Some(2608), routine: Some("ri_ReportViolation") }\n\n   0: sql_schema_connector::apply_migration::apply_script\n           with migration_name="20260627133148_asset_management_core"\n             at schema-engine/connectors/sql-schema-connector/src/apply_migration.rs:113\n   1: schema_commands::commands::apply_migrations::Applying migration\n           with migration_name="20260627133148_asset_management_core"\n             at schema-engine/commands/src/commands/apply_migrations.rs:95\n   2: schema_core::state::ApplyMigrations\n             at schema-engine/core/src/state.rs:260	2026-06-27 13:32:58.96514+00	2026-06-27 13:31:48.337844+00	0
\.
...
8fdad616-d44a-4cbb-bfd8-710672eb4c51	e27df716-e8fb-4f11-af9f-faea09c25466	1	总经理	confirm	t
55d12bad-4254-4600-b724-ca8b6b14d84f	e27df716-e8fb-4f11-af9f-faea09c25466	2	业主代表	approve	t
\.
...
e27df716-e8fb-4f11-af9f-faea09c25466	任务完成审批流程	task_completion	用于任务负责人上传完成支持文件后的完成审批。	t	2026-06-27 02:52:10.172	2026-06-27 02:52:10.172
\.
...
6cb26c05-5a7c-4e7e-ac32-d8cb118904a5	e27df716-e8fb-4f11-af9f-faea09c25466	8fdad616-d44a-4cbb-bfd8-710672eb4c51	c7d0d7bc-23ed-4ae2-9aa3-4049bd8e773b	task_completion	7095ccb5-1a06-488e-a275-d26489367bc2	approved	拟同意	2026-06-27 02:56:51.187	\N	\N	\N	\N	\N
9a8f6711-9a71-49c9-9445-47f50af3ac5a	e27df716-e8fb-4f11-af9f-faea09c25466	55d12bad-4254-4600-b724-ca8b6b14d84f	c7d0d7bc-23ed-4ae2-9aa3-4049bd8e773b	task_completion	600189e4-7476-4e86-bf57-dd1c4bdac059	approved	\N	2026-06-27 02:56:51.203	\N	\N	\N	\N	\N
\.


--
-- Data for Name: asset_change_requests; Type: TABLE DATA; Schema: public; Owner: admin
--

COPY public.asset_change_requests (id, entity_type, entity_id, action, payload, status, submit_note, requested_by, approved_at, created_at, updated_at) FROM stdin;
\.


--
-- Data for Name: asset_items; Type: TABLE DATA; Schema: public; Owner: admin
--

COPY public.asset_items (id, item_no, item_name, item_dec, item_brand, item_unit, bsstype, assettype, status, remark, created_at, updated_at) FROM stdin;
\.


--
-- Data for Name: asset_settings; Type: TABLE DATA; Schema: public; Owner: admin
--

COPY public.asset_settings (id, category, code, name, description, status, sort_order, remark, created_at, updated_at) FROM stdin;
b50bbdee-8e06-40c8-bdfa-75fa630a09de	cost_center	1	Rooms Office	\N	active	1	\N	2026-06-27 13:51:43.014	2026-06-27 13:51:43.014
85db137a-f835-4a8f-9d5e-29d5f4a82781	item_unit	BAG	袋	\N	active	1	\N	2026-06-27 13:51:43.074	2026-06-27 14:03:18.74
11d596a4-55e5-4b1e-bd97-c16860fd5e61	tax_rate	0	0	\N	active	1	\N	2026-06-27 13:51:43.088	2026-06-27 13:51:43.088
45962b2a-6f17-4a6a-bf7c-35d63185171b	cost_center	2	Front Office	\N	active	2	\N	2026-06-27 13:51:43.089	2026-06-27 13:51:43.089
d1714911-7570-4629-a466-317fc02a46e3	item_category	1677	Printing and Stationery 印刷品	\N	active	1	\N	2026-06-27 13:51:43.075	2026-06-27 14:03:18.785
57206cb0-ec9b-4af4-adec-4b9bdd2bfb61	tax_rate	0.01	0.01	\N	active	2	\N	2026-06-27 13:51:43.102	2026-06-27 13:51:43.102
97de129e-bcd7-4a19-bf48-370ab081aef4	cost_center	3	Housekeeping	\N	active	3	\N	2026-06-27 13:51:43.106	2026-06-27 13:51:43.106
9bcad915-fa6d-425a-8f27-4b6a9daf93cd	operation_type	RC	收货	\N	active	1	\N	2026-06-27 13:51:43.081	2026-06-27 14:03:18.794
b7f6cfc3-77cb-4005-a425-8731ac9fe7d7	tax_rate	0.03	0.03	\N	active	3	\N	2026-06-27 13:51:43.117	2026-06-27 13:51:43.117
f167f58b-2aab-4d1f-ba89-1d0e64d0a22d	cost_center	4	Laundry	\N	active	4	\N	2026-06-27 13:51:43.117	2026-06-27 13:51:43.117
c090fadd-9099-444e-bcfd-ad2fad6e4ebf	item_unit	BTL	瓶	\N	active	4	\N	2026-06-27 13:51:43.12	2026-06-27 14:03:18.824
9e851948-2c66-43d1-827f-0c097f59275c	item_category	1697	Cleaning Supplies 清洁用品	\N	active	4	\N	2026-06-27 13:51:43.122	2026-06-27 14:03:18.828
83083df7-26d0-4e02-9d5a-bca54c6b3764	operation_type	DA	报损	\N	active	4	\N	2026-06-27 13:51:43.123	2026-06-27 14:03:18.829
24d09af3-19a7-4ee6-9b57-290239edb791	item_unit	BUN	束	\N	active	5	\N	2026-06-27 13:51:43.128	2026-06-27 14:03:18.829
6db98dfb-3981-41a5-b767-fd29503af57f	item_category	1707	Laundry Supplies 洗衣用品	\N	active	5	\N	2026-06-27 13:51:43.132	2026-06-27 14:03:18.829
9c538407-fc77-4d80-b377-4862cc5108e9	operation_type	OT	其它调整	\N	active	5	\N	2026-06-27 13:51:43.137	2026-06-27 14:03:18.83
a7749543-484d-4838-9edd-923346c25bf6	item_unit	BX	盒	\N	active	6	\N	2026-06-27 13:51:43.14	2026-06-27 14:03:18.83
92e4caca-39c0-44e1-bd6d-b380ad5a1353	item_category	1711	Paper and Plastics 纸和塑料	\N	active	6	\N	2026-06-27 13:51:43.14	2026-06-27 14:03:18.835
e28a4986-3b3a-4df1-bb70-2e08409dc270	item_unit	CAN	罐	\N	active	7	\N	2026-06-27 13:51:43.147	2026-06-27 14:03:18.835
5c8f3aed-7051-4c5e-812e-8c5ec211a211	item_category	1712	Misc Service Equipment 其它服务设备	\N	active	7	\N	2026-06-27 13:51:43.148	2026-06-27 14:03:18.839
1da5747b-868c-4986-b25d-afcf32df489a	item_unit	CS	箱	\N	active	8	\N	2026-06-27 13:51:43.151	2026-06-27 14:03:18.84
cc244cbc-7350-48f8-84c8-34eb2a16e809	item_category	1716	Ice 其它运营用品-冰	\N	active	8	\N	2026-06-27 13:51:43.151	2026-06-27 14:03:18.842
db80bd60-57e9-4dad-9b66-e22d9947a08f	item_unit	CTN	纸箱（外箱）	\N	active	9	\N	2026-06-27 13:51:43.154	2026-06-27 14:03:18.852
bf2b5ead-d5c4-4669-97c9-c3e2b2b77c0d	item_category	1717	Operating Supplies 运营用品	\N	active	9	\N	2026-06-27 13:51:43.154	2026-06-27 14:03:18.853
f3a5b921-91ce-4591-97a1-a2dfb971812d	item_unit	DZ	打（12个）	\N	active	10	\N	2026-06-27 13:51:43.159	2026-06-27 14:03:18.854
04e6e5fb-5b29-4567-814e-7103fa007fcd	item_category	1775	Office Supplies 办公用品	\N	active	10	\N	2026-06-27 13:51:43.159	2026-06-27 14:03:18.854
24694f99-bad3-4296-a47b-62591fc4fbe7	item_unit	EA	个	\N	active	11	\N	2026-06-27 13:51:43.161	2026-06-27 14:03:18.855
69d44fa5-21ab-4ec8-83f5-ec02a5395494	item_category	1777	Health and Beauty Products 健康美容产品	\N	active	11	\N	2026-06-27 13:51:43.165	2026-06-27 14:03:18.859
e29e4d89-3c1d-46c4-acdf-1d98ea36b217	asset_type	OE	OE	运营物资	active	1	需要进行盘点	2026-06-27 13:51:43.073	2026-06-27 14:04:54.626
96c6e7f8-9ff8-4f0d-afb9-7553dda89cff	asset_type	Fixed assets	Fixed assets	固定资产	active	2	需要进行盘点	2026-06-27 13:51:43.091	2026-06-27 14:05:10.351
41c9b6b6-0821-4da5-b4e3-cc916fd7213a	asset_type	Cost/Expense	Cost/Expense	成本/费用	active	3	\N	2026-06-27 13:51:43.107	2026-06-27 14:05:18.489
d3a38708-c490-458c-bc1f-b9f8434d4da4	item_unit	G	克	\N	active	12	\N	2026-06-27 13:51:43.196	2026-06-27 14:03:18.863
bc56c99f-81c7-43a2-85ee-8ec2bc1921aa	cost_center	12	The Lounge	\N	active	12	\N	2026-06-27 13:51:43.193	2026-06-27 13:51:43.193
d4fdf4a7-d21b-496f-b5a9-0a2c0315796e	item_category	1815	Flatware 餐具(指刀，叉，匙等)	\N	active	12	\N	2026-06-27 13:51:43.196	2026-06-27 14:03:18.864
cc956da6-b4e7-430f-b15c-2920114de6d4	cost_center	13	Terrace Bar	\N	active	13	\N	2026-06-27 13:51:43.201	2026-06-27 13:51:43.201
7bab873d-c4a8-4918-b881-f54f0a545190	item_unit	GAL	加仑	\N	active	13	\N	2026-06-27 13:51:43.205	2026-06-27 14:03:18.866
21fe46d2-592d-45ff-8d75-9824a5c3b7e4	cost_center	14	Executive Lounge	\N	active	14	\N	2026-06-27 13:51:43.209	2026-06-27 13:51:43.209
f4c53ec7-cbb0-4190-a072-931b93725805	item_category	1816	China 陶瓷器	\N	active	13	\N	2026-06-27 13:51:43.206	2026-06-27 14:03:18.87
6c3ac397-0a0a-499e-943e-1ba7ed651a30	cost_center	15	In-Room Dining	\N	active	15	\N	2026-06-27 13:51:43.215	2026-06-27 13:51:43.215
6f4c0dce-654d-4165-a6b9-fb41fe1ec2d9	item_unit	IN	英寸	\N	active	14	\N	2026-06-27 13:51:43.211	2026-06-27 14:03:18.87
006f9e60-af1a-4461-9b5e-ade07fa02bec	cost_center	16	Mini Bar	\N	active	16	\N	2026-06-27 13:51:43.221	2026-06-27 13:51:43.221
baa20b51-44b6-4010-8797-a92aa5dfe764	item_category	1817	Glassware 玻璃器具	\N	active	14	\N	2026-06-27 13:51:43.212	2026-06-27 14:03:18.871
2d30a701-a7c2-488d-b94b-04db5e4ce487	cost_center	17	Man Ho	\N	active	17	\N	2026-06-27 13:51:43.227	2026-06-27 13:51:43.227
aaa15c0c-9fe3-4122-bd3d-5006f4abc68f	item_unit	KG	千克	\N	active	15	\N	2026-06-27 13:51:43.216	2026-06-27 14:03:18.875
b281833b-8ede-4dc5-bad9-81275e3b122d	cost_center	18	Banquets	\N	active	18	\N	2026-06-27 13:51:43.231	2026-06-27 13:51:43.231
fa7ee828-fac4-4249-8021-8a307918084f	item_category	1819	Linen 布草	\N	active	15	\N	2026-06-27 13:51:43.22	2026-06-27 14:03:18.88
7eee151c-33af-4713-9f93-24c99f96830b	cost_center	19	Staff - Housing	\N	active	19	\N	2026-06-27 13:51:43.238	2026-06-27 13:51:43.238
8ceb98ad-ce20-4503-b629-cdbfa16c8aaf	item_unit	LTR	公升	\N	active	16	\N	2026-06-27 13:51:43.222	2026-06-27 14:03:18.882
21d90952-7934-433e-bcb5-83581497392e	cost_center	20	Administrative and General	\N	active	20	\N	2026-06-27 13:51:43.243	2026-06-27 13:51:43.243
db046a58-f3f2-43ba-8405-7ad38bb44fd6	item_category	1826	Uniforms 制服鞋袜	\N	active	16	\N	2026-06-27 13:51:43.225	2026-06-27 14:03:18.882
548e823e-51db-49c7-ad28-307c88c96363	cost_center	21	Human Resources	\N	active	21	\N	2026-06-27 13:51:43.246	2026-06-27 13:51:43.246
0dff7493-45a0-464f-a268-1c9c2c397775	item_unit	M	米	\N	active	17	\N	2026-06-27 13:51:43.228	2026-06-27 14:03:18.883
6a6f1531-8f85-46d2-874d-ea4ea92d6ce3	cost_center	22	Loss Prevention	\N	active	22	\N	2026-06-27 13:51:43.249	2026-06-27 13:51:43.249
7cf871d3-5cad-409f-bd4d-68927bdb017d	item_category	1836	Promotions 促销物料	\N	active	17	\N	2026-06-27 13:51:43.229	2026-06-27 14:03:18.883
27ab1ff3-e9e6-42e5-94a2-32a342a227cf	cost_center	23	Accounting	\N	active	23	\N	2026-06-27 13:51:43.252	2026-06-27 13:51:43.252
73065ea0-98ba-4d74-ae6e-3d68599a012b	item_unit	ML	毫升	\N	active	18	\N	2026-06-27 13:51:43.234	2026-06-27 14:03:18.885
e7c74fe4-1d9e-4b08-a346-6e4a5d0d0c34	cost_center	24	Sales and Marketing	\N	active	24	\N	2026-06-27 13:51:43.254	2026-06-27 13:51:43.254
e633b5a5-5561-4b37-be1a-4ce6d056e7e3	item_category	1837	Trade Shows 贸易展览物料	\N	active	18	\N	2026-06-27 13:51:43.235	2026-06-27 14:03:18.885
f6cf0c8e-0c52-4138-aaf4-d0c49b43be6c	cost_center	25	Reservation	\N	active	25	\N	2026-06-27 13:51:43.255	2026-06-27 13:51:43.255
7db23ad3-6d46-4a6a-9c5d-4df155bb8b61	item_unit	PC	支	\N	active	19	\N	2026-06-27 13:51:43.24	2026-06-27 14:03:18.886
c93ce0ad-4418-4e2f-9a38-7a5970dc56f7	cost_center	26	Property Operation and Maint	\N	active	26	\N	2026-06-27 13:51:43.257	2026-06-27 13:51:43.257
4b5cb45c-f55d-47fa-b424-41520280360e	item_category	1841	MC Plants Int Ext 植物摆件	\N	active	19	\N	2026-06-27 13:51:43.241	2026-06-27 14:03:18.886
c79a2c95-26ca-408a-b06a-829e9daae30c	item_unit	PK	包	\N	active	20	\N	2026-06-27 13:51:43.243	2026-06-27 14:03:18.886
d4eeea15-136a-49b9-be6a-0f41b585be07	item_category	1952	Vehicle Repairs and Maint 工程类-车辆维修	\N	active	43	\N	2026-06-27 13:51:43.314	2026-06-27 14:03:18.936
a2237887-302b-4986-8c4f-53948d12950d	item_category	1953	Gasoline and Lubricants 工程类-汽油和润滑油	\N	active	44	\N	2026-06-27 13:51:43.316	2026-06-27 14:03:18.938
5fffb102-0c9c-47e3-afd6-09a17636ee3e	item_category	1904	Light Bulbs 工程类-灯泡	\N	active	45	\N	2026-06-27 13:51:43.318	2026-06-27 14:03:18.939
31538daf-f1b8-440e-a4ba-033f95b71628	item_category	1915	Tools 工程类-工具	\N	active	46	\N	2026-06-27 13:51:43.32	2026-06-27 14:03:18.941
9dc45dbe-fa6d-4c13-8350-27e48b39d5fc	item_category	1964	Capex 工程类-固定资产项目	\N	active	47	\N	2026-06-27 13:51:43.325	2026-06-27 14:03:18.942
\.


--
-- Data for Name: asset_suppliers; Type: TABLE DATA; Schema: public; Owner: admin
--

COPY public.asset_suppliers (id, suppliers_id, suppliers_name_cn, suppliers_name_en, suppliers_city, contact_person, contact_title, contact_number, email, invoice_name, tax_id, invoice_add, bank, bank_account_no, status, remark, created_at, updated_at) FROM stdin;
\.
...
015520fb-9293-4506-8d10-4556fd9ce7bc	7095ccb5-1a06-488e-a275-d26489367bc2	approval	有新的任务完成申请需要审批: POB提交	\N	project	a8676196-de2d-47ec-b6f3-940376485611	t	2026-06-27 02:56:51.197
a571a32c-97bc-4c76-ad7f-0dd5b0581f2d	600189e4-7476-4e86-bf57-dd1c4bdac059	approval	有新的任务完成申请需要审批: POB提交	\N	project	a8676196-de2d-47ec-b6f3-940376485611	t	2026-06-27 02:56:51.205
d74e6847-a665-450d-ace1-0c8afec61ad1	2d2dc4c4-6cf4-426c-9032-e055447815c8	approval	您的任务完成申请已通过审批	\N	project	a8676196-de2d-47ec-b6f3-940376485611	t	2026-06-27 03:15:16.342
\.
...
b403f436-93ea-432b-90c7-934c2d61e4b6	assets	view	查看资产管理
5db379d9-0761-46e6-aaca-24264fd562b6	assets	purchase	资产采购
c60993f6-9f9c-48ff-8bf4-213b8e8fc3dc	assets	receiving	收货管理
13826806-00b9-4c39-b914-b486cb544c07	assets	inventory	库存管理
d3eb49f5-5597-4f75-856c-24f143b7fbdf	assets	cost	成本管理
7f717263-6ba5-4285-a9c3-b569e122d799	assets	manage_items	物资管理
e68ade64-808b-415b-988a-f630a743417a	assets	manage_suppliers	供应商管理
52ef15e7-37eb-4880-acb8-a437314c34e7	assets	reports	资产报表
35541968-0e21-4932-995c-900abd409a9d	assets	import_export	资产数据导入导出
18c22de2-6ae7-4cc2-ab47-091f6e3d3736	settings	manage_asset_settings	管理资产规则设置
\.
...
--
-- Data for Name: task_files; Type: TABLE DATA; Schema: public; Owner: admin
--

COPY public.task_files (id, task_id, filename, original_name, size, mime_type, file_type, uploaded_by, uploaded_at) FROM stdin;
ce80c547-b27b-4c68-b436-7f2e1e5a25f3	c7d0d7bc-23ed-4ae2-9aa3-4049bd8e773b	d2d6540f-0427-43de-a608-a0468393c136.docx	ååå®¡æ ¸æ¥å-æ·±å³ç¾é«æ¢éåº2026å¹´æ±¡æ°´äºäºçç¯¦å­æ´æ¢åå-20260611.docx	44621	application/vnd.openxmlformats-officedocument.wordprocessingml.document	completion	9b768321-9f6d-41cf-a761-a1df265c4a06	2026-06-27 02:25:12.558
\.
...
COPY public.tasks (id, project_id, parent_id, title, description, status, priority, assignee_id, start_date, due_date, completed_at, sort_order, created_at, updated_at, progress, relative_to_target, start_offset_days, due_offset_days, completion_note, completion_submitted_at, completion_approved_at) FROM stdin;
c7d0d7bc-23ed-4ae2-9aa3-4049bd8e773b	a8676196-de2d-47ec-b6f3-940376485611	\N	POB提交	编制筹备期预算	done	medium	2d2dc4c4-6cf4-426c-9032-e055447815c8	2027-03-22 00:00:00	2027-04-01 00:00:00	2026-06-27 03:15:16.333	1	2026-06-27 01:38:12.559	2026-06-27 03:15:16.335	100	t	-100	-90	\N	2026-06-27 02:56:51.207	2026-06-27 03:15:16.333
7c8cc935-525a-4307-b1c6-61e809c7654a	a8676196-de2d-47ec-b6f3-940376485611	\N	HOE采购预算提交		todo	medium	2d2dc4c4-6cf4-426c-9032-e055447815c8	2027-01-31 00:00:00	2027-02-10 00:00:00	\N	2	2026-06-27 01:39:33.475	2026-06-27 03:48:47.214	0	t	-150	-140	\N	\N	\N
\.
...
--
-- Name: asset_change_requests asset_change_requests_pkey; Type: CONSTRAINT; Schema: public; Owner: admin
--

ALTER TABLE ONLY public.asset_change_requests
    ADD CONSTRAINT asset_change_requests_pkey PRIMARY KEY (id);


--
-- Name: asset_items asset_items_pkey; Type: CONSTRAINT; Schema: public; Owner: admin
--
...
--
-- Name: asset_settings asset_settings_pkey; Type: CONSTRAINT; Schema: public; Owner: admin
--

ALTER TABLE ONLY public.asset_settings
    ADD CONSTRAINT asset_settings_pkey PRIMARY KEY (id);


--
-- Name: asset_suppliers asset_suppliers_pkey; Type: CONSTRAINT; Schema: public; Owner: admin
--

ALTER TABLE ONLY public.asset_suppliers
    ADD CONSTRAINT asset_suppliers_pkey PRIMARY KEY (id);
...
--
-- Name: task_files task_files_pkey; Type: CONSTRAINT; Schema: public; Owner: admin
--
...
--
-- Name: asset_items_item_no_key; Type: INDEX; Schema: public; Owner: admin
--

CREATE UNIQUE INDEX asset_items_item_no_key ON public.asset_items USING btree (item_no);


--
-- Name: asset_settings_category_code_key; Type: INDEX; Schema: public; Owner: admin
--

CREATE UNIQUE INDEX asset_settings_category_code_key ON public.asset_settings USING btree (category, code);


--
-- Name: asset_suppliers_suppliers_id_key; Type: INDEX; Schema: public; Owner: admin
--

CREATE UNIQUE INDEX asset_suppliers_suppliers_id_key ON public.asset_suppliers USING btree (suppliers_id);
...
--
-- Name: task_files_task_id_idx; Type: INDEX; Schema: public; Owner: admin
--

CREATE INDEX task_files_task_id_idx ON public.task_files USING btree (task_id);


--
-- Name: tasks_completion_submitted_at_idx; Type: INDEX; Schema: public; Owner: admin
--

CREATE INDEX tasks_completion_submitted_at_idx ON public.tasks USING btree (completion_submitted_at);
...
--
-- Name: asset_change_requests asset_change_requests_requested_by_fkey; Type: FK CONSTRAINT; Schema: public; Owner: admin
--

ALTER TABLE ONLY public.asset_change_requests
    ADD CONSTRAINT asset_change_requests_requested_by_fkey FOREIGN KEY (requested_by) REFERENCES public.users(id) ON UPDATE CASCADE ON DELETE RESTRICT;
...
--
-- Name: task_files task_files_task_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: admin
--

ALTER TABLE ONLY public.task_files
    ADD CONSTRAINT task_files_task_id_fkey FOREIGN KEY (task_id) REFERENCES public.tasks(id) ON UPDATE CASCADE ON DELETE CASCADE;


--
-- Name: task_files task_files_uploaded_by_fkey; Type: FK CONSTRAINT; Schema: public; Owner: admin
--

ALTER TABLE ONLY public.task_files
    ADD CONSTRAINT task_files_uploaded_by_fkey FOREIGN KEY (uploaded_by) REFERENCES public.users(id) ON UPDATE CASCADE ON DELETE SET NULL;
...
\unrestrict KbDNUeja7t2T30GJfZwitz0ZgoqLvaQv2pg1de5dRC0IsrvQfsXaHjm3CigjJ5E
