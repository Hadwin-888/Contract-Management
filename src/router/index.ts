...
const routes: RouteRecordRaw[] = [
  ...
  {
    path: '/assets',
    redirect: '/assets/purchase',
  },
  {
    path: '/assets/purchase',
    name: 'AssetPurchase',
    component: () => import('@/views/assets/AssetPurchaseView.vue'),
    meta: { requiresAuth: true, permission: 'asset-purchase' as Permission, title: '采购' },
  },
  {
    path: '/assets/receiving',
    name: 'AssetReceiving',
    component: () => import('@/views/assets/AssetReceivingView.vue'),
    meta: { requiresAuth: true, permission: 'asset-receiving' as Permission, title: '收货' },
  },
  {
    path: '/assets/inventory',
    name: 'AssetInventory',
    component: () => import('@/views/assets/AssetInventoryView.vue'),
    meta: { requiresAuth: true, permission: 'asset-inventory' as Permission, title: '库存管理' },
  },
  {
    path: '/assets/cost',
    name: 'AssetCost',
    component: () => import('@/views/assets/AssetPlaceholderView.vue'),
    meta: { requiresAuth: true, permission: 'asset-cost' as Permission, title: '成本管理' },
  },
  {
    path: '/assets/suppliers',
    name: 'AssetSuppliers',
    component: () => import('@/views/assets/AssetSupplierView.vue'),
    meta: { requiresAuth: true, permission: 'asset-suppliers' as Permission },
  },
  {
    path: '/assets/items',
    name: 'AssetItems',
    component: () => import('@/views/assets/AssetItemView.vue'),
    meta: { requiresAuth: true, permission: 'asset-items' as Permission },
  },
  {
    path: '/assets/reports',
    name: 'AssetReports',
    component: () => import('@/views/assets/AssetPlaceholderView.vue'),
    meta: { requiresAuth: true, permission: 'asset-reports' as Permission, title: '报表' },
  },
  {
  ...
  },
  {
    ...
    children: [
      ...
      },
      {
        path: 'asset-settings',
        name: 'AssetSettings',
        component: () => import('@/views/settings/AssetSettingsView.vue'),
        meta: { requiresAuth: true, permission: 'asset-settings' as Permission },
      },
    ],
  },
]
