export default {
  platform: {
    name: 'Shenzhen MGM Hotel Admin Platform',
    shortName: 'Shenzhen MGM',
    slogan: 'Contracts, procurement, and approvals',
  },
  nav: {
    dashboard: 'Dashboard',
    projects: 'Projects',
